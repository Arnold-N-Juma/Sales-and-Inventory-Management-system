...
class Main(Login,Admin,User):
    ...
    def buildmain(self):
        ...
        self.topframe=LabelFrame(self.mainw,width=1400,height=120,bg="brown")
        self.topframe.place(x=0,y=0)
        self.store_name = ' Ndombi'
        self.storelable=Label(self.topframe,text=self.store_name + "'s Sales System",bg="brown",anchor="center")
