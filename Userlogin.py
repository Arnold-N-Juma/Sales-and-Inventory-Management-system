'''
    ...
    Developed By->Arnold,Brandon,Ian,Lance,Kevin, Ken
...
class Login:
    ...
    def obj(self):
        ...
        self.signin = Button(self.loginframe,width=20, text="Sign in",bg="light blue",fg="dimgray",command=self.checkuser,font="Roboto 14")
